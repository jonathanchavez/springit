package com.vega.sprinit.bootstrap;
...
//has a single method run, bringing in link and comment reposiotory getting it autowired in by construstors
//call each with link reposioty save
...
//sping manage thses beans themselves
